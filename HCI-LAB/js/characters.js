...
card1.onclick = function(){
    ...
    document.querySelector("#desc p").innerText = "As the Acting Grand Master of the Knights, Jean has always been devoted to her duties and maintaining peace in Mondstadt. She had taken precautions long before the onset of Stormterror's assault, and she will guard Mondstadt with her life as always."
}
...
card21.onclick = function(){
    ...
    document.querySelector("#desc2 p").innerText = "Hu Tao is the 77th Director of the Wangsheng Funeral Parlor, a person vital to managing Liyue's funerary affairs. She does her utmost to flawlessly carry out a person's last rites and preserve the world's balance of yin and yang."
}
...
card23.onclick = function(){
    ...
    document.querySelector("#desc2 p").innerText = "Captain of the Crux, with quite the reputation in Liyue.There are those who say she can split mountains and part the sea. Others say she draws lightning through her sword. Some say that even the mightiest of sea beasts are no match for her. For those not from Liyue, it may sound like a hearty joke, but those that have sailed with her will say— 'No matter what sea beasts there may be, Beidou will be sure to split them all in two.'"
}
...
card31.onclick = function(){
    ...
    document.querySelector("#desc3 p").innerText = "Daughter of the Yashiro Commission's Kamisato Clan from Inazuma. Dignified and elegant, wise and determined. Sincere and pleasant to others. Universally loved by the Inazuma people, she has earned the title of Shirasagi Himegimi."
}
...
card32.onclick = function(){
    ...
    document.querySelector("#desc3 p").innerText = "The Raiden Shogun is the awesome and terrible power of thunder incarnate, the exalted ruler of the Inazuma Shogunate. With the might of lightning at her disposal, she commits herself to the solitary pursuit of eternity."
}
...
card33.onclick = function(){
    ...
    document.querySelector("#desc3 p").innerText = "A talented pyrotechnician. The current owner of Naganohara Fireworks known as the 'Queen of the Summer Festival.' A girl filled with fiery passion. The uncompromising childish innocence and the obsession with craftsmanship intertwine in her to create a spectacular blaze."
}
...
card41.onclick = function(){
    ...
    document.querySelector("#desc4 p").innerText = "The guardian of Aaru Village who is gentle and benevolent. She will not allow anyone to harm Aaru Village under her watch."
}
...
card42.onclick = function(){
    ...
    document.querySelector("#desc4 p").innerText = "Lesser Lord Kusanali dwells deep in the Sanctuary of Surasthana, and has never really been in the limelight, nor has she even been mentioned much. Her burden is heavy, but though she may experience loneliness, and though darkness is all she sees before her, she will not stop moving forward."
}
...
card43.onclick = function(){
    ...
    document.querySelector("#desc4 p").innerText = "A member of'The Eremites' a loosely-organized mercenary organization. She is brave, powerful, and enjoys an excellent reputation among mercenaries."
}
